...
```bash
curl -sL https://raw.githubusercontent.com/corsar-dred/mtproto-installer/main/deploy_mtproto-1.sh https://raw.githubusercontent.com/corsar-dred/mtproto-installer/main/deploy_mtproto-1.sh -o deploy_mtproto-1.sh && chmod +x deploy_mtproto-1.sh && ./deploy_mtproto-1.sh
```
